...
builder.Services.AddScoped<IRepository<BeltConstructor>, Repository<BeltConstructor>>();
builder.Services.AddScoped<IRepository<BeltType>, Repository<BeltType>>();
...
builder.Services.AddScoped<IRepository<NeckConstructor>, Repository<NeckConstructor>>();
builder.Services.AddScoped<IRepository<NeckType>, Repository<NeckType>>();
builder.Services.AddScoped<IRepository<Order>, Repository<Order>>();
builder.Services.AddScoped<IRepository<OrderHistory>, Repository<OrderHistory>>();
builder.Services.AddScoped<IRepository<PantsConstructor>, Repository<PantsConstructor>>();
builder.Services.AddScoped<IRepository<PantsCuffConstructor>, Repository<PantsCuffConstructor>>();
builder.Services.AddScoped<IRepository<PantsCuffType>, Repository<PantsCuffType>>();
builder.Services.AddScoped<IRepository<PantsType>, Repository<PantsType>>();
...
builder.Services.AddScoped<IRepository<SleeveConstructor>, Repository<SleeveConstructor>>();
builder.Services.AddScoped<IRepository<SleeveCuffConstructor>, Repository<SleeveCuffConstructor>>();
builder.Services.AddScoped<IRepository<SleeveCuffType>, Repository<SleeveCuffType>>();
builder.Services.AddScoped<IRepository<SleeveType>, Repository<SleeveType>>();
builder.Services.AddScoped<IRepository<SportSuitConstructor>, Repository<SportSuitConstructor>>();
builder.Services.AddScoped<IRepository<SweaterConstructor>, Repository<SweaterConstructor>>();
builder.Services.AddScoped<IRepository<SweaterType>, Repository<SweaterType>>();
