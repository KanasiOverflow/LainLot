...
export default class ContactsService {
    ...
    static async GetContactsCount() {
        ...
        const options = {
            method: 'get',
            url: 'http://localhost:8040/api/v1/Database/GetContactsCount',
            auth: {
    ...
    static async GetContactsFields() {
        ...
        const options = {
            method: 'get',
            url: 'http://localhost:8040/api/v1/Database/GetContactsFields',
            auth: {
                username: secureLocalStorage.getItem('login'),
                password: secureLocalStorage.getItem('password')
            }
    ...
    static async GetContactById(id) {
        ...
        const options = {
            method: 'get',
            url: 'http://localhost:8040/api/v1/Database/GetContactById',
            params: { id: id },
            auth: {
                username: secureLocalStorage.getItem('login'),
                password: secureLocalStorage.getItem('password')
    ...
    static async CreateContact(newRecord) {
        ...
        const options = {
            method: 'post',
            url: 'http://localhost:8040/api/v1/Database/CreateContact',
    ...
    static async UpdateContact(oldRecord) {
        ...
        const options = {
            method: 'put',
            url: 'http://localhost:8040/api/v1/Database/UpdateContact',
            headers: { 'Content-Type': 'application/json' },
    ...
    static async DeleteContact(id) {
        ...
        const options = {
            method: 'delete',
            url: 'http://localhost:8040/api/v1/Database/DeleteContact',
            params: { id: id },
            auth: {
                username: secureLocalStorage.getItem('login'),
                password: secureLocalStorage.getItem('password')
