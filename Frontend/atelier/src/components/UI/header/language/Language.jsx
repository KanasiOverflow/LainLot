...
export default function Language() {
    ...
    const languages = {
        en: { label: "English", flag: "images/uk_16x16.png", title: "United Kingdom" },
    ...
    return (
        <div className={mcss.lang_box}>
            <button className="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                <img src={currentLang.flag} alt="flag" className="mr-2" title={currentLang.title} />
                {currentLang.label}
